...
## System Code: 
Push your group's code to this repository, including a README with (1) a link(https://main--beautiful-pie-a4edbf.netlify.app/) to the hosted system, and (2) instructions to run the system locally. To host the system, Github pages should be sufficient if all you need is a static site (i.e., no database or server-side code). 
